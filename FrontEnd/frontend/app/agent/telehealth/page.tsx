...
export default function AgentTelehealthPage() {
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <p className="text-gray-500 text-sm">Loading clinic telehealth consultations...</p>
      </div>
    );
  }
    ...
    return (
      <div className="text-center py-20 max-w-md mx-auto">
        ...
        <p className="text-gray-500 text-sm mb-6">
          There was an error retrieving telehealth sessions. Please try again.
        </p>
        <button
          onClick={() => refetch()}
          className="px-4 py-2 bg-[#E03E3E] hover:bg-[#c93232] text-white text-xs font-semibold rounded-md transition-all cursor-pointer shadow-none"
        >
          Try Again
        </button>
      </div>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-100 pb-5">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Monitor and coordinate active, upcoming, and past telehealth sessions across the clinic.
          </p>
        </div>
      </div>
